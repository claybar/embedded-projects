...
// Sending calculated results to an MQTT topic via ethernet

// default MAC address on our LAN (0x53 => .83)
// this will be overwritten by the address read from the I2C device
...
byte mqttBroker[] = { 192, 168, 178, 10 };
...
const byte currentSensor_CT4 = 6;   // analogue 
...
const float voltageCal = 0.875;

const float scaleFactor_CT1 = 2.74394;  // 
const float scaleFactor_CT2 = 2.74394;  // 
const float scaleFactor_CT3 = 2.74394;  // 
const float scaleFactor_CT4 = 2.74394;  // 

const float powerCal_CT1 = (235.1*(3.3/1023))*(60.606*(3.3/1023))*scaleFactor_CT1; // <---- powerCal value
const float powerCal_CT2 = (235.1*(3.3/1023))*(11.111*(3.3/1023))*scaleFactor_CT2; // <---- powerCal value
const float powerCal_CT3 = (235.1*(3.3/1023))*(60.606*(3.3/1023))*scaleFactor_CT3; // <---- powerCal value
const float powerCal_CT4 = (235.1*(3.3/1023))*(11.111*(3.3/1023))*scaleFactor_CT4; // <---- powerCal value
...
{  
  ...
  Serial.println();
  Serial.println();
  Serial.println("Sketch ID: emontx_cont_direct.ino");
  ...
  Serial.print ( "powerCal_CT1 = "); Serial.println (powerCal_CT1,6);
  Serial.print ( "phaseCal_CT1 = "); Serial.println (phaseCal_CT1);
  Serial.print ( "powerCal_CT2 = "); Serial.println (powerCal_CT2,6);
  Serial.print ( "phaseCal_CT2 = "); Serial.println (phaseCal_CT2);
  Serial.print ( "powerCal_CT3 = "); Serial.println (powerCal_CT3,6);
  Serial.print ( "phaseCal_CT3 = "); Serial.println (phaseCal_CT3);
  Serial.print ( "powerCal_CT4 = "); Serial.println (powerCal_CT4,6);
    ...
    {  
      if (polarityOfLastSampleV != POSITIVE)
      {
        ...
        {         
          ...
          tx_data.Vrms_timesTen = 10 * sqrt(sum_Vsquared / samplesDuringThisCycle) * voltageCal;
...
void send_data()
{
  ...
  publishData("power.CT1", tx_data.power_CT1);
  publishData("power.CT2", tx_data.power_CT2);
  publishData("power.CT3", tx_data.power_CT3);
  publishData("power.CT4", tx_data.power_CT4);
  publishData("voltagex10", tx_data.Vrms_timesTen);
